...
class Product extends Model
{
    ...
    // Champs pouvant Ãªtre mass assignable
    protected $fillable = [
        'name',
        'category_id',
        'subcategory_id',
    ...
    /**
     * RÃ©cupÃ¨re les couleurs disponibles pour ce produit via les variantes.
     */
    ...
    /**
     * RÃ©cupÃ¨re les tailles disponibles pour ce produit via les variantes.
     */
    ...
    /**
     * Accesseur pour l'attribut image - retourne l'image_path ou une image par dÃ©faut.
     */
    public function getImageAttribute()
    {
        if ($this->image_path) {
            // Si l'image_path commence par 'http', c'est une URL complÃ¨te
        ...
        // Retourne l'image par dÃ©faut
        return asset('images/placeholder.jpg');
    }

    /**
     * Un produit peut Ãªtre dans plusieurs wishlists.
     */
    ...
    /**
     * RÃ©cupÃ¨re les avis approuvÃ©s uniquement.
     */
    ...
    /**
     * Compte le nombre total d'avis approuvÃ©s.
     */
    ...
    /**
     * VÃ©rifie si un produit est dans la wishlist d'un utilisateur.
     */
    ...
    /**
     * Calcule la plage de prix (min, max) Ã  partir des variantes.
    ...
    /**
     * Accesseurs calcules exposes vers le frontend.
     */
    protected $appends = ['image', 'average_rating', 'reviews_count', 'price_range', 'price_min', 'price_max'];

    /**
     * Expose price_min depuis price_range pour compatibilité FE.
     */
    ...
    /**
     * Expose price_max depuis price_range pour compatibilité FE.
     */
