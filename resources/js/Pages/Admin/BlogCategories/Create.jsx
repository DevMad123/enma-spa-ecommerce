        ...
        <AdminLayout>
            ...
            <div className="py-6 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900">Créer une Nouvelle Catégorie</h1>
                </div>
                    ...
                    <div className="bg-white shadow-sm rounded-lg p-6 space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            />
                            <p className="text-xs text-gray-500 mt-1">Plus le nombre est petit, plus la catégorie apparaîtra en premier</p>
                        </div>
