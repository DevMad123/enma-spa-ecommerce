...
export default function EditSupplier({ supplier, title }) {
    const [imagePreview, setImagePreview] = useState(supplier.image ? `/${supplier.image}` : null);
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        status: supplier.status ? 1 : 0, // Convertir en 1/0 pour le select
        image: null,
    });
    ...
    const handleSubmit = (e) => {
        ...
        router.post(route('admin.suppliers.update', supplier.id), formData, {
            onStart: () => {
                console.log('🚀 Début de la mise à jour du fournisseur');
            },
            onSuccess: (data) => {
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500">
                                Modifier les informations de {supplier.supplier_name}
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">
                                        PNG, JPG, GIF jusqu'à 2MB. Laisser vide pour conserver l'image actuelle.
                                    </p>
                                    {errors.image && (
