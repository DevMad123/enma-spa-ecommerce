...
export default function ProductModal({
  ...
  <Modal open={open} onClose={onClose} aria-labelledby="product-modal-title">
    <Box className="bg-white rounded-2xl shadow-2xl overflow-y-auto max-h-[90vh] transition-all duration-300 transform"
      sx={{
        position: "absolute",
        top: "50%",
        left: "50%",
    ...
    >
    {/* Header */}
    <div className="flex justify-between items-center mb-6 p-6 border-b border-gray-200 bg-[#f7f3ee]">
      <h2
      id="product-modal-title"
      className="text-2xl flex items-center gap-2 font-semibold text-[#8c6c3c]"
      >
      {mode === "edit" ? (
        <>
