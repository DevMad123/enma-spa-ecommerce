...
export default function CreateColor({ title }) {
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                        ...
                                        <ul className="text-sm text-blue-700 space-y-1">
                                            <li>• Utilisez des noms descriptifs (ex: "Rouge cerise", "Bleu océan")</li>
                                            <li>• Assurez-vous que le code couleur correspond visuellement</li>
                                            <li>• Évitez les doublons avec les couleurs existantes</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
