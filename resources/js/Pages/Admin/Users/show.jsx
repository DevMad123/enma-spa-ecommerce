            ...
            <div className="mb-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                    <div className="flex items-center flex-wrap gap-2">
                        ...
                        <h1 className="text-xl md:text-2xl font-bold text-gray-900 truncate max-w-[70vw] sm:max-w-none">{user.name}</h1>
                    ...
                    <div className="flex items-center gap-2 sm:space-x-3 flex-wrap sm:flex-nowrap">
                        ...
                        <button
                            ...
                            className={`w-full sm:w-auto inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md font-semibold text-xs uppercase tracking-widest ${
