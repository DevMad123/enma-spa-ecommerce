...
export default function CreateSize({ title }) {
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                            ...
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-xs">
                                    <div>
                                        <strong className="text-blue-800">Vêtements:</strong>
                                        <br />XS, S, M, L, XL, XXL
                                    </div>
                                    <div>
                                        <strong className="text-blue-800">Chaussures (EU):</strong>
                                        <br />36, 37, 38, 39, 40, 41, 42
                                    </div>
                                    <div>
                                        <strong className="text-blue-800">Pantalons:</strong>
                                        <br />28, 30, 32, 34, 36, 38
                                    </div>
                                    <div>
                                        <strong className="text-blue-800">Personnalisé:</strong>
                    ...
                    <div className="mt-8 bg-amber-50 border border-amber-200 rounded-lg p-4">
                        <h3 className="text-sm font-medium text-amber-800 mb-2">
                            📋 Conseils pour nommer vos tailles
                        </h3>
                        <ul className="text-xs text-amber-700 space-y-1">
                            <li>• Utilisez des noms clairs et standards (S, M, L ou 38, 40, 42)</li>
                            <li>• Évitez les caractères spéciaux complexes</li>
                            <li>• Restez cohérent dans votre système de tailles</li>
                            <li>• Pensez à vos clients : utilisez des tailles familières</li>
                        </ul>
                    </div>
                </div>
            </div>
