...
import { initLocale, getLocaleConfig } from '@/Utils/LocaleUtils';
import { 
    ArrowLeftIcon,
    CreditCardIcon,
    CheckCircleIcon,
...
export default function CreatePaymentMethod() {
    const { availableMethods, localeConfig } = usePage().props;
    ...
    const handleMethodChange = (code) => {
        ...
        const methodName = availableMethods && availableMethods[code] ? availableMethods[code] : code;
        setData({
            ...data,
            code: code,
            name: methodName,
        ...
        setConfigFields(configFieldsMapping[code] || []);
    };
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-gray-900">Créer une Méthode de Paiement</h1>
                                <p className="text-gray-600">Ajoutez une nouvelle méthode de paiement</p>
                            </div>
                        </div>
                        <Link
                    ...
                    <form onSubmit={submit} className="p-6 space-y-6">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-3">
                                Type de Méthode de Paiement <span className="text-red-500">*</span>
                            </label>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {availableMethods && Object.entries(availableMethods).map(([code, name]) => (
                                    <button
                                        key={code}
                                        type="button"
                                    ...
                                    >
                                        <div className="flex items-center space-x-3">
                                            <span className="text-2xl">{getPaymentMethodIcon(code)}</span>
                                            <div>
