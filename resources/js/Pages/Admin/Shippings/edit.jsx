...
export default function ShippingEdit({ shipping }) {
    ...
    const { data, setData, put, processing, errors } = useForm({
        ...
        supports_free_shipping: shipping.supports_free_shipping ?? false,
    ...
    const handleSubmit = (e) => {
        ...
        put(route('admin.shippings.update', shipping.id));
    };

    return (
        <AdminLayout>
            <Head title="Modifier le mode de livraison" />
            ...
            <div className="mb-6">
                <div className="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Modifier le mode de livraison</h1>
                        <p className="mt-1 text-sm text-gray-600">
                            Modifier les informations du mode de livraison "{shipping.name}".
                        </p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-white shadow rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="text-center p-4 bg-gray-50 rounded-lg">
                            <div className="text-2xl font-bold text-indigo-600">{shipping.sells_count || 0}</div>
                        ...
                        <div className="text-center p-4 bg-gray-50 rounded-lg">
                            <div className="text-2xl font-bold text-orange-600">
                                {shipping.estimated_days ? `${shipping.estimated_days}j` : 'N/A'}
                            </div>
                            <div className="text-sm text-gray-600">Délai</div>
                        </div>
                        <div className="text-center p-4 bg-gray-50 rounded-lg">
                            <div className={`text-2xl font-bold ${shipping.is_active ? 'text-green-600' : 'text-red-600'}`}>
                ...
                <div className="flex justify-end space-x-3">
                    ...
                    >
                        {processing ? 'Modification...' : 'Modifier le mode de livraison'}
                    </button>
                </div>
            </form>
        </AdminLayout>
