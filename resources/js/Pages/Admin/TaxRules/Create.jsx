...
export default function CreateTaxRule({ title }) {
    ...
    const removeDeliveryZone = (index) => {
        ...
        setData('delivery_zones', newZones.filter(zone => zone.trim() !== ''));
    };
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    <h1 className="text-3xl font-bold text-gray-900 flex items-center">
                                        ...
                                        Nouvelle règle de TVA
                                    </h1>
                                    <p className="text-gray-600 mt-1">
                                        Créer une nouvelle règle de TVA pour un pays
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        <div className="px-8 py-6 border-b border-gray-200 bg-gray-50">
                            ...
                            <p className="text-gray-600 text-sm mt-1">
                                Configurez les règles de TVA et de livraison pour ce pays
                            </p>
                        </div>
