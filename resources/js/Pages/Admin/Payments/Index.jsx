...
export default function PaymentsList() {
    ...
    const handleBulkAction = (action, selectedIds) => {
        ...
        if (action === 'delete') {
            if (confirm(`Êtes-vous sûr de vouloir supprimer ${selectedIds.length} paiement(s) ?`)) {
                router.post(route('admin.payments.bulk-delete'), {
                    ids: selectedIds
                });
            }
            ...
            router.post(route('admin.payments.bulk-validate'), {
                ids: selectedIds
            });
        }
    };
    ...
    const handleDelete = (paymentId) => {
        if (confirm('Êtes-vous sûr de vouloir supprimer ce paiement ?')) {
            router.delete(route('admin.payments.destroy', paymentId));
        }
    };
    ...
    const handleView = (paymentId) => {
        router.visit(route('admin.payments.show', paymentId));
    };
    ...
    const getStatusBadge = (status) => {
        const statusConfig = {
            ...
            refunded: { color: 'bg-orange-100 text-orange-800', icon: ArrowPathIcon },
        };

        const config = statusConfig[status] || { color: 'bg-gray-100 text-gray-800', icon: XCircleIcon };
    ...
    const actions = [
        {
            type: 'button',
            onClick: (payment) => handleView(payment.id),
            icon: EyeIcon,
    ...
    const searchableFields = ['reference', 'amount', 'method', 'status'];
    ...
    return (
        <AdminLayout>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-600">
                            Gérez et suivez tous les paiements et transactions
                        </p>
                    </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd className="text-lg font-medium text-gray-900">{stats.total_payments || 0}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-white overflow-hidden shadow rounded-lg">
                    <div className="p-5">
                        <div className="flex items-center">
                            ...
                            <div className="ml-5 w-0 flex-1">
                                <dl>
                                    <dt className="text-sm font-medium text-gray-500 truncate">Paiements Réussis</dt>
                                    <dd className="text-lg font-medium text-gray-900">{stats.successful_payments || 0}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd className="text-lg font-medium text-gray-900">{stats.pending_payments || 0}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <div className="flex-1">
                                <div className="relative">
                                    ...
                                    <input
                                        type="text"
                                        placeholder="Rechercher par référence, commande, client..."
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setActiveFilters(prev => ({ ...prev, date_from: e.target.value }))}
                                            className="w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setActiveFilters(prev => ({ ...prev, date_to: e.target.value }))}
                                            className="w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
                                        />
                                    </div>
                                </div>
            ...
            <DataTable
                ...
                searchPlaceholder="Rechercher par référence, montant, méthode ou statut..."
